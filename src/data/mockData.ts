...
const holidayCharityProposals: HolidayCharityProposal[] = [
  {
    id: 'hcp-veterans-day-2025',
    type: 'holiday_charity',
    title: 'Veterans Day 2025 - Charity Selection',
    author: 'system',
    status: 'active',
    ...
    abstainPercentage: 0,
    description:
      'Vote for which charity should receive funding for Veterans Day 2025. Total fund allocation: $150,000. Select your preferred charity from the available options.',
    createdAt: new Date('2025-01-10'),
    votingEndsAt: new Date('2025-01-25'),
    holidayId: 'veterans-day',
    availableCharities: ['1', '2', '3', '4', '5', '6'],
    isAutoGenerated: true,
    fundAmount: 150000,
    votingType: 'charity_selection',
    charityVotes: {
      '1': { votes: 45, percentage: 35.2 },
      '2': { votes: 32, percentage: 25.0 },
      '3': { votes: 19, percentage: 14.8 },
      '4': { votes: 16, percentage: 12.5 },
      '5': { votes: 10, percentage: 7.8 },
      '6': { votes: 6, percentage: 4.7 },
    },
    totalVotes: 128,
    leadingCharity: '1',
  },
