...
export const CharityDirectoryVoting: React.FC<CharityDirectoryVotingProps> = ({
  proposal,
  onVoteSubmitted,
}) => {
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                className={cn('text-sm font-medium', verificationStatus.color)}
              >
      ...
      >
        <SimpleTooltip text="Vote to add this charity to the VMF directory">
          <Button
            ...
            size="lg"
          >
            {isSubmitting ? 'Submitting...' : '✅ Vote Yes - Add to Directory'}
          </Button>
        </SimpleTooltip>
