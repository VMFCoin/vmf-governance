...
export const CharityCard: React.FC<CharityCardProps> = memo(
  ({ charity, onViewImpact, className }) => {
  ...
  (prevProps, nextProps) => {
    ...
    return (
      prevProps.charity.id === nextProps.charity.id &&
      prevProps.charity.name === nextProps.charity.name &&
      prevProps.charity.logo === nextProps.charity.logo &&
